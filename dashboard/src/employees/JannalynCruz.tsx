...
export default function JannalynCruz() {
  ...
  useEffect(() => {
    audioRef.current = new Audio('/sounds/cruz.mp3')
  }, [])
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('jannalyn-cruz-orders')
      .on(
        'postgres_changes',
        { event: 'INSERT', schema: 'public', table: 'orders', filter: `category=eq.Action Figures` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'UPDATE', schema: 'public', table: 'orders', filter: `category=eq.Action Figures` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'DELETE', schema: 'public', table: 'orders', filter: `category=eq.Action Figures` },
        (payload) => {
    ...
    return (
      <div style={styles.modal}>
        <div style={styles.modalContent}>
          <h2>Jannalyn Cruz - Action Figures</h2>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>🦸 Jannalyn Cruz - Action Figures</h1>
