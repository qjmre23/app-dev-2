...
export default function JohnMarwin() {
  ...
  useEffect(() => {
    audioRef.current = new Audio('/sounds/ebona.mp3')
  }, [])
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('john-marwin-orders')
      .on(
        'postgres_changes',
        { event: 'INSERT', schema: 'public', table: 'orders', filter: `category=eq.Toy Guns` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'UPDATE', schema: 'public', table: 'orders', filter: `category=eq.Toy Guns` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'DELETE', schema: 'public', table: 'orders', filter: `category=eq.Toy Guns` },
        (payload) => {
    ...
    return (
      <div style={styles.modal}>
        <div style={styles.modalContent}>
          <h2>John Marwin Ebona - Toy Guns</h2>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>🔫 John Marwin Ebona - Toy Guns</h1>
