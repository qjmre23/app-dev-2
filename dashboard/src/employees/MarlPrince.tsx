...
export default function MarlPrince() {
  ...
  useEffect(() => {
    audioRef.current = new Audio('/sounds/marl.mp3')
  }, [])
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('marl-prince-orders')
      .on(
        'postgres_changes',
        { event: 'INSERT', schema: 'public', table: 'orders', filter: `category=eq.Dolls` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'UPDATE', schema: 'public', table: 'orders', filter: `category=eq.Dolls` },
        (payload) => {
      ...
      .on(
        'postgres_changes',
        { event: 'DELETE', schema: 'public', table: 'orders', filter: `category=eq.Dolls` },
        (payload) => {
    ...
    return (
      <div style={styles.modal}>
        <div style={styles.modalContent}>
          <h2>Prince Marl Lizandrelle Mirasol - Dolls</h2>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>👗 Prince Marl Lizandrelle Mirasol - Dolls</h1>
